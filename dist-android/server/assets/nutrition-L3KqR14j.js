//#region src/lib/fitlife/nutrition.ts
var NUTRITION_DISCLAIMER = "This is general educational information only and is not medical or dietary advice. Individual needs vary. Speak to a qualified doctor or registered dietitian before making significant changes, especially if you have a health condition, are pregnant, or take medication.";
var NUTRITION_ARTICLES = [
	{
		slug: "protein",
		icon: "🍗",
		title: "Protein",
		summary: "The building block your body uses to repair and maintain muscle.",
		description: "Protein provides amino acids, which your body uses to repair tissue after training and to maintain muscle over time. Most general guidance suggests spreading protein across your meals rather than eating it all in one sitting.",
		benefits: [
	...
	},
	{
		...
		description: "Carbohydrates are broken down into glucose, which fuels higher-intensity exercise. Minimally processed sources also bring fibre, vitamins and minerals along with the energy.",
		benefits: [
	...
	},
	{
		...
		description: "Fats are energy dense and essential. Unsaturated fats from foods like nuts, seeds, olive oil and oily fish are generally emphasised in dietary guidelines over heavily processed and saturated fat sources.",
		benefits: [
	...
	},
	{
		...
		description: "Fruit provides vitamins, minerals, fibre and water in a convenient package. Variety matters: different colours tend to bring different nutrients.",
		benefits: [
			"Supports fibre intake",
			"Contributes to daily hydration",
			"Convenient alternative to sugary snacks"
		],
		examples: [
			"Berries",
			"Bananas",
	...
	},
	{
		...
		description: "Vegetables add nutrients and bulk to meals for very few calories, which can make eating in a calorie deficit far more comfortable.",
		benefits: [
			"Adds volume to meals without many calories",
			"Broad range of vitamins and minerals",
			"Supports fibre and gut health"
		],
		examples: [
			"Broccoli",
	...
	},
	{
		...
		description: "Even mild dehydration can make training feel harder. Needs vary with body size, climate and activity, so use thirst and urine colour as practical everyday cues.",
		benefits: [
			"Supports temperature regulation during exercise",
		...
		examples: [
			...
			"Sparkling water",
			"Herbal tea",
			"Water-rich fruit like watermelon",
			"Milk"
		],
		tips: [
	...
	},
	{
		...
		description: "A meal with carbohydrates and some protein 1-3 hours before training suits most people. Closer to the session, smaller and lower-fibre snacks tend to sit better.",
		benefits: [
			"Can improve energy during the session",
			"Reduces the chance of feeling light-headed",
			"Helps you maintain intensity"
		],
		examples: [
	...
	},
	{
		...
		description: "After training, a meal containing protein and carbohydrates supports recovery. The old 30-minute 'anabolic window' idea is now considered much less strict — total daily intake matters more.",
		benefits: [
			"Supports muscle repair",
			"Replenishes energy stores",
			"Helps you feel recovered for the next session"
		],
		examples: [
	...
	},
	{
		...
		description: "Snacks that combine protein or fat with fibre tend to keep you satisfied longer than refined carbohydrates alone. Portioning ahead of time helps.",
		benefits: [
			"Steadier energy between meals",
			"Can reduce overeating at dinner",
			"Extra chance to hit protein and fibre targets"
		],
		examples: [
...
//#endregion
export { NUTRITION_DISCLAIMER as n, getArticle as r, NUTRITION_ARTICLES as t };
